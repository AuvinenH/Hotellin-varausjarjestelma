...
public class RoomServiceTests
{
    ...
    public async Task CreateAsync_AddsAndSaves_WhenRoomNumberIsUnique()
    {
        ...
        Assert.Equal(RoomCategory.Standard, result.Category);
    ...
    [Fact]
    public async Task CreateAsync_ThrowsConflict_WhenRoomNumberAlreadyExists()
    {
        var repository = new Mock<IRoomRepository>();
        var service = new RoomService(repository.Object);
    ...
    [Fact]
    public async Task UpdateAsync_ThrowsConflict_WhenAnotherRoomUsesSameNumber()
    {
        var repository = new Mock<IRoomRepository>();
        var service = new RoomService(repository.Object);
        ...
        await Assert.ThrowsAsync<ConflictException>(() => service.UpdateAsync(targetRoom.Id, request, CancellationToken.None));
